...
const Contact = () => {
  return (
    <>
      <section className="w-full md:w-[80vw] relative z-10 overflow-hidden bg-black p-8 sm:p-14 md:p-20 lg:py-[120px]">
              ...
              <div className="mb-12 max-w-[570px] lg:mb-0">
                ...
                <div className="mb-8 flex w-full max-w-[370px]">
                  ...
                  <div className="w-full">
                    ...
                    <p className="text-base text-body-color dark:text-dark-6">
                      7154 A Sunrise Prestige Park Electronic City Bengaluru 560100. India
                    </p>
                  </div>
                </div>
                ...
                <div className="mb-8 flex w-full max-w-[370px]">
                  ...
                  <div className="w-full">
                    ...
                    <p className="text-base text-body-color dark:text-dark-6">
                      info@utkristi-labs.io
                    </p>
                  </div>
                </div>
              </div>
            </div>
            <div className="w-full px-4 lg:w-1/2 xl:w-5/12 shadow-md">
              <div className="relative rounded-lg bg-yellow-600 p-6 shadow-lg sm:p-12 text-black">
                <form>
                  ...
                  <div>
                    <button
                      type="submit"
                      className="w-full focus:border border-primary bg-black p-3 text-white transition hover:bg-opacity-90"
                    >
                      Send Message
                    </button>
                  </div>
