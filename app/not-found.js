    ...
    <section className="bg-transparent py-7 min-h-[70vh]">
      <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
        <div className="mx-auto max-w-screen-sm text-center">
          ...
          <p className="mb-4 text-3xl tracking-tight font-bold text-gray-400 md:text-4xl dark:text-white">Something's missing.</p>
          <p className="mb-4 text-lg font-light text-gray-300 dark:text-gray-200">Sorry, we can't find that page. You'll find lots to explore on the home page.</p>
            <Link href="/">
